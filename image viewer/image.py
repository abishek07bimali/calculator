...
window.iconbitmap('image.png')                                         #adding icon in title
# create frame
...
def next():
    ...
    try:
        ...
        next()
# create buttons    
btn1 = Button(window, text="Previous",width=8, bd=5,bg='white', fg='green', font=('cambria 15 bold'), relief=RAISED, command=previous)
...
btn2 = Button(window, text="Next", width=8, bd=5,bg='white', fg='green', font=('cambria 15 bold'), relief=RAISED, command=next)
